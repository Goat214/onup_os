...
// ========== COURSES DATA ==========
const allCourses = [
  { icon: <FaCrown />,      name: "Лидерлик (Оффлайн)",      duration: "40 күн • 1.5 саат",        category: "Өнүгүү", type: "Оффлайн" },
  { icon: <FaCrown />,      name: "Лидерлик (Онлайн)",       duration: "40 күн • 1.5 саат",        category: "Өнүгүү", type: "Онлайн"  },
  { icon: <FaBookOpen />,   name: "Тез окуу (Оффлайн)",      duration: "1 ай • 12 күн • 1.5 саат", category: "Өнүгүү", type: "Оффлайн" },
  { icon: <FaBookOpen />,   name: "Тез окуу (Онлайн)",       duration: "1 ай • 12 күн • 1.5 саат", category: "Өнүгүү", type: "Онлайн"  },
  { icon: <FaLayerGroup />, name: "Жети тепкич (Оффлайн)",   duration: "1 ай • 6 күн • 2 саат",    category: "Өнүгүү", type: "Оффлайн" },
  { icon: <FaLayerGroup />, name: "Жети тепкич (Онлайн)",    duration: "1 ай • 6 күн • 2 саат",    category: "Өнүгүү", type: "Онлайн"  },
  { icon: <FaLanguage />,   name: "Англис тили",             duration: "1 ай • 6 күн • 2 саат",    category: "Тилдер", type: "Стандарт" },
  { icon: <FaLanguage />,   name: "Орус тили",               duration: "1 ай • 6 күн • 2 саат",    category: "Тилдер", type: "Стандарт" },
  { icon: <FaLaptopCode />, name: "IT көндүмдөрү (Оффлайн)", duration: "1 ай • 12 күн • 2 саат",   category: "IT",     type: "Оффлайн" },
];
...
// ========== TEXT REVIEWS ==========
const initReviews = [
  { photo: null, name: "Бекзод Насриддинов",     role: "SMM адис",             text: "Onup OS бүтүрүүчүлөрү ар тараптуу билимге ээ. Берилген тапшырмаларды аракет менен аткарышат. Айрыкча копирайтинг боюнча билим жана көндүм берилиши мыкты. Жеке блог жүргүзүүгө мажбурлашкандары жакшы — ушундан улам иштеме дагы эле пайдасын тийгизип жатат. Бүтүргөнүмдөн бери 1 жылдан ашты." },
  { photo: null, name: "Улукбек Рахманов",        role: "График дизайнер",      text: "Ассалому алейкум, Onup OS жамаасына, устаттарына жана жетекчилигине чоң рахмат. Onup OS ту тандаганыма өкүнбөймүн — бул жерге тажрыйбалуу адистер чогулган. Fullstack курсунда бардык керектүү билимдерди алдым жана учурда Корея компаниясында иштеп жатам. Курсту баарына сунуштайм." },
  { photo: null, name: "Акбар Ахмаджанов",        role: "Fullstack программист", text: "Ассалому алейкум. «Onup OS» борборунда Front-End курсун бүтүрдүм. Учурда Back-End курсунда окуп жатам. Курстар абдан жакшы уюштурулган. Устаттар тажрыйбалуу жана жамаат ынак." },
  { photo: null, name: "Хумоюн Мирзо",            role: "Frontend программист",  text: "Мен dotNET курсунда окуйм. «Onup OS» окутуу системасы жана мугалимдердин билими жөнүндө пикирим оң. «Onup OS» да окугусу келгендерге ийкемдиксиз келип окушун сунуштайм." },
  { photo: null, name: "Рустамкулов Мухаммадали", role: "Программист",           text: "SMM Pro курсунда окуйм. Курс жөнүндө пикирим чынчыл. Бул курс маркетингге керектүү бардык билимдер кубаттуу адистер тарабынан түзүлгөн." },
  { photo: null, name: "Жонибек Саломатов",       role: "SMM адис",             text: "«Onup OS» бүтүрүүчүлөрүнүн ар тараптуу билими бар. Берилген тапшырмаларды аракет менен аткарышат. Жеке блог жүргүзүүгө мажбурлашкандары жакшы. Бүтүргөнүмдөн бери 1 жылдан ашты." },
];

// ========== BONUSES ==========
const bonuses = [
  { img: null, emoji: "💰", title: "100 000 сомго чейинки акчалай сыйлык",      desc: "Англис тили курсу IELTS үчүн 10 000 сомго чейин каржылоо" },
  { img: null, emoji: "📚", title: "Онлайн курсту бекер алыңыз",                desc: "Окуу борбордо билим алууну көздөгөн жана курс үчүн алдын ала толук төлөм төлөгөндөр үчүн ӨНҮП ӨС онлайн платформасынан 10 000 сомго чейинки курстар бекер берилет." },
  { img: null, emoji: "🎓", title: "Чет өлкөгө саякаттоого мүмкүнчүлүк",       desc: "Мелдештер учурунда жылына жок дегенде бир жолу чет өлкөгө акысыз саякаттоо мүмкүнчүлүгүн беребиз." },
  { img: null, emoji: "✈️", title: "Лидер VIP групасын бүтүргөндөргө Умра сертификаты", desc: "Лидер VIP групаны ийгиликтүү бүтүргөндөргө Саудияга умрага сертификат." },
  { img: null, emoji: "🏖️", title: "Ысык-Көлгө путёвка",                        desc: "Лидер групасын ийгиликтүү бүтүргөндөргө Ысык-Көлгө путёвка." },
];
...
// ========== BRANDS ==========
const brandRows = [
  ["Компания 1","Компания 2","Компания 3","Компания 4","Компания 5","Компания 6","Компания 7","Компания 8","Компания 9","Компания 10","Компания 11","Компания 12"],
  ["Компания 13","Компания 14","Компания 15","Компания 16","Компания 17","Компания 18","Компания 19","Компания 20","Компания 21","Компания 22","Компания 23","Компания 24"],
  ["Компания 25","Компания 26","Компания 27","Компания 28","Компания 29","Компания 30","Компания 31","Компания 32","Компания 33","Компания 34","Компания 35","Компания 36"],
];

// ========== AWARDS ==========
const awards = [
  { img: null, emoji: "🏆", year: "2024-жыл", title: "«Жылдын мыкты IT мектеби» номинациясынын жеңүүчүсү" },
  { img: null, emoji: "🥇", year: "2024-жыл", title: "«Жылдын бренди» номинациясы" },
  { img: null, emoji: "🎖️",year: "2023-жыл", title: "«Тахсин» сыйлыгынын лауреаты" },
...
export default function Home() {
  ...
  const [phone1, setPhone1] = useState(""); const [name1, setName1] = useState(""); const [agree1, setAgree1] = useState(false);
  const [phone2, setPhone2] = useState(""); const [name2, setName2] = useState(""); const [agree2, setAgree2] = useState(false);
  const [phone3, setPhone3] = useState(""); const [name3, setName3] = useState(""); const [agree3, setAgree3] = useState(false);
  const [showAll, setShowAll]   = useState(false);
  const [expanded, setExpanded] = useState({});
  const [locTab, setLocTab]     = useState(0);
  const [enroll, setEnroll]     = useState({ course:"", date:"", time:"", name:"", phone:"", agree:false });
  const intervalRef = useRef(null);

  const filters = ["Баары","Өнүгүү","Тилдер","IT"];
  const filteredCourses = filter === "Баары" ? allCourses : allCourses.filter((c) => c.category === filter);
  ...
  const submitEnroll = (e) => {
    ...
    setEnroll({ course:"", date:"", time:"", name:"", phone:"", agree:false });
  };
      ...
      <section className="why-sec reveal">
        <div className="wrap">
          ...
          <div className="why-grid">
            {[
              { icon:"🖥️", title:"Бекер коворкинг",            desc:"24/7 форматында иштеген бекер коворкинг жана wifi." },
              { icon:"🎓", title:"Сапаттуу билим",              desc:"Дайыма жаңыланып турган курстар жана чоң тажрыйбага ээ устаттар." },
              { icon:"🏆", title:"Үзгүлтүксүз мелдештер",       desc:"Китеп сынактар, мелдештер." },
              { icon:"🎙️",title:"Бекер мастер-класстар",       desc:"Тармак адистери менен дайыма өткөрүлүүчү бекер мастер-класстар." },
              { icon:"💼", title:"Жумуш сунуштоо кепилдиги *",  desc:"«Onup OS» интенсив курстарды ийгиликтүү бүтүргөн окуучуларга жумуш сунуштоо кепилдигин берет. *" },
              { icon:"📜", title:"Сертификат",                  desc:"Курсту ийгиликтүү аяктаган окуучулар «Onup OS» дипломун жана сертификатын алат." },
            ].map((r, i) => (
          ...
          <div className="vidrev-grid">
            {videoReviews.map((v, i) => (
              <div className="vidrev-card" key={i}>
                {v.src ? (
                  <>
                    <video src={v.src} poster={v.poster || undefined} controls preload="none" />
                    <div className="vidrev-overlay"><span>{v.name}</span></div>
                  </>
                ) : (
            ...
            {visibleReviews.map((r, i) => (
              <div className="txtrev-item" key={i}>
                ...
                <div className="tr-body">
                  <p className={`tr-text ${expanded[i] ? "" : "collapsed"}`}>{r.text}</p>
          ...
          {initReviews.length > 3 && (
            <div className="toggle-wrap">
              <button className="btn-outline" onClick={() => setShowAll(!showAll)}>
                {showAll ? "Жабуу ▲" : `Дагы көрүү (${initReviews.length - 3}) ▼`}
              </button>
            </div>
          )}
        </div>
        ...
        <div className="wrap">
          <div className="consult-photo-inner">
            <div className="consult-photo-img">
              {regPhoto ? <img src={regPhoto} alt="Каттоо бөлүмү" /> : <div className="img-ph">🏫</div>}
            </div>
            <div className="consult-box">
              <h2>Бекер консультация</h2>
              <p>Телефон номериңизди жазып калтырыңыз, биз сизге чалабыз жана бир да сурооңуз жооп алынбай калбасына аракет кылабыз</p>
              <form className="c-form" onSubmit={submitConsult(name2, phone2, agree2, () => { setName2(""); setPhone2(""); setAgree2(false); })}>
            ...
            {directions.map((d, i) => (
              <Link to={d.path} className="dir-card" key={i}>
                <div className="dir-img">
                  {d.img ? <img src={d.img} alt={d.title} /> : <span>{d.emoji}</span>}
                </div>
                <h3>{d.title}</h3>
              </Link>
            ))}
            ...
            {eduTypes.map((e, i) => (
              <Link to={e.path} className="edu-card" key={i}>
                <div className="edu-img">
                  {e.img ? <img src={e.img} alt={e.title} /> : <span>{e.emoji}</span>}
                </div>
                <h3>{e.title}</h3>
              </Link>
            ))}
        ...
        {brandRows.map((row, ri) => (
          <div className="brands-row" key={ri}>
            <div className={`brands-track ${ri % 2 === 1 ? "rev" : ""}`}>
              {[...row, ...row].map((b, bi) => (
                <div className="brand-item" key={bi}><span>{b}</span></div>
              ))}
            </div>
          </div>
        ))}
      ...
      <section className="consult-sec dark reveal" id="consult2">
        <div className="wrap">
          <div className="consult-box">
            <h2>Бекер консультация</h2>
            <p>Телефон номериңизди жазып калтырыңыз, биз сизге чалабыз жана бир да сурооңуз жооп алынбай калбасына аракет кылабыз</p>
            <form className="c-form" onSubmit={submitConsult(name3, phone3, agree3, () => { setName3(""); setPhone3(""); setAgree3(false); })}>
        ...
        <div className="wrap">
          ...
          <div className="enroll-inner">
            ...
            <form className="enroll-form" onSubmit={submitEnroll}>
              ...
              <input
                type="text" placeholder="Атыңыз" value={enroll.name}
