...
const initReviews = [
  ...
  },
  {
    ...
    role: "Программист",
    text: "SMM Pro курсунда окуйм. Курс жөнүндө пикирим чынчыл. Бул курс маркетингге керектүү бардык билимдер кубаттуу адистер тарабынан түзүлгөн.",
  },
  {
    photo: null,
    name: "Жонибек Саломатов",
    role: "SMM адис",
    text: "«Onup OS» бүтүрүүчүлөрүнүн ар тараптуу билими бар. Берилген тапшырмаларды аракет менен аткарышат. Жеке блог жүргүзүүгө мажбурлашкандары жакшы. Бүтүргөнүмдөн бери 1 жылдан ашты.",
  },
];
...
const bonuses = [
  ...
  },
  {
    ...
    desc: "Окуу борбордо билим алууну көздөгөн жана курс үчүн алдын ала толук төлөм төлөгөндөр үчүн ӨНҮП ӨС онлайн платформасынан 10 000 сомго чейинки курстар бекер берилет.",
  },
  {
    img: null,
    emoji: "🎓",
  ...
  },
  {
    img: null,
    emoji: "✈️",
    title: "Лидер VIP групасын бүтүргөндөргө Умра сертификаты",
        ...
        <div className="wrap">
          ...
          <div className="about-cards">
            ...
            <div className="about-card">
              ...
              <p>
                10 000дөн ашык студентти жана 100дөн ашык команданы бириктирген
                инновация борбору.
              </p>
            </div>
          </div>
          ...
          <div className="why-grid">
            {[
              ...
              },
              {
                icon: "📜",
                title: "Саякатто",
                desc: "Курсту ийгиликтүү аяктаган окуучулар музейлерге, библотекаларга тарыхый жана эс алуу жайларына 'ӨНҮП ӨС' окуу борборунун генеральдык директорун буйругу менен саякаттоо мүмкүнчүлүгүнө ээ болушат.",
              },
            ].map((r, i) => (
